        ...
        try {
          ...
          if (body && typeof body === 'object') {
            if (body instanceof ReadableStream || 'locked' in body) {
              ...
              try {
                ...
                const data = new Uint8Array(chunks.reduce((acc, chunk) => [...acc, ...chunk], []))
          ...
          try {
            ...
            await payload.sendEmail({
              from: process.env.EMAIL_FROM || 'website@dfc.studio',
              to: process.env.CONTACT_EMAIL || 'matt.beer@designersforclimate.net',
              subject: 'New Contact Form Submission',
              replyTo: email,
              html: `
                <h2>dfc.studio | New contact form submission</h2>
